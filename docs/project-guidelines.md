...
- Priority should be given to producing a working solution in the allotted time - _Done is better than perfect_. Brief comments may be left to explain optimisations / improvements that would be implemented with more time & there will be an opportunity to expand on this at interview.
